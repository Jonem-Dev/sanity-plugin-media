...
const inputs = {
  ...
  inCurrentDocument: {
    ...
    options: [{
      name: "true",
      title: "True",
      value: groq(_a$m || (_a$m = __template$m(["_id in $documentAssetIds"])))
    }, {
      name: "false",
      title: "False",
      value: groq(_b$c || (_b$c = __template$m(["!(_id in $documentAssetIds)"])))
    }],
    selectOnly: true,
  ...
  inUse: {
    ...
    options: [{
      name: "true",
      title: "True",
      value: groq(_c$5 || (_c$5 = __template$m(["count(*[references(^._id)]) > 0"])))
    }, {
      name: "false",
      title: "False",
      value: groq(_d$2 || (_d$2 = __template$m(["count(*[references(^._id)]) == 0"])))
    }],
    title: "In use",
    type: "select",
    value: "true"
...
const constructFilter = _ref => {
  ...
  ...(searchQuery ? [groq(_b$b || (_b$b = __template$l(["[_id, altText, assetId, creditLine, description, originalFilename, title, url] match '*", "*'"])), searchQuery.trim())] : []),
  // Search facets
...
const checkTagName = (client, name) => {
  return function (source) {
    return source.pipe(mergeMap(() => {
      return from(client.fetch(groq(_a$k || (_a$k = __template$k(['count(*[_type == "', '" && name.current == $name])'])), TAG_DOCUMENT_NAME), {
        name
      }));
...
const ASSETS_ACTIONS = {
  ...
  directoriesAddComplete: createAction("actions/directoriesAddComplete", function prepare7(_ref8) {
    let {
      assets,
      directory
    } = _ref8;
  ...
  directoriesAddError: createAction("actions/directoriesAddError", function prepare8(_ref9) {
    let {
      assets,
      error,
      directory
  ...
  directoriesAddRequest: createAction("actions/directoriesAddRequest", function prepare9(_ref10) {
    let {
      assets,
      directory
    } = _ref10;
  ...
  directoriesRemoveComplete: createAction("actions/directoriesRemoveComplete", function prepare10(_ref11) {
    let {
      assets,
      directory
    } = _ref11;
  ...
  directoriesRemoveError: createAction("actions/directoriesRemoveError", function prepare11(_ref12) {
    let {
      assets,
      error,
      directory
  ...
  directoriesRemoveRequest: createAction("actions/directoriesRemoveRequest", function prepare12(_ref13) {
    let {
      assets,
      directory
    } = _ref13;
...
const DIALOG_ACTIONS = {
  ...
  showDirectoryCreate: createAction("dialog/showDirectoryCreate", function prepare(_ref14) {
    let {
      directory
    } = _ref14;
    return {
  ...
  showTagEdit: createAction("dialog/showTagEdit", function prepare2(_ref15) {
    let {
      tagId
    } = _ref15;
    return {
  ...
  showDirectoryEdit: createAction("dialog/showDirectoryEdit", function prepare3(_ref16) {
    let {
      directoryId
    } = _ref16;
    return {
...
const tagsCreateEpic = (action$, state$, _ref17) => {
  ...
  return action$.pipe(filter(tagsSlice.actions.createRequest.match), withLatestFrom(state$), mergeMap(_ref18 => {
...
const tagsDeleteEpic = (action$, state$, _ref19) => {
  ...
  return action$.pipe(filter(tagsSlice.actions.deleteRequest.match), withLatestFrom(state$), mergeMap(_ref20 => {
    ...
    mergeMap(() => client.observable.fetch(groq(_b$a || (_b$a = __template$j(['*[\n              _type in ["sanity.fileAsset", "sanity.imageAsset"]\n              && references(*[_type == "media.tag" && name.current == $tagName]._id)\n            ] {\n              _id,\n              _rev,\n              opt\n            }']))), {
...
const tagsFetchEpic = (action$, state$, _ref21) => {
  ...
  return action$.pipe(filter(tagsSlice.actions.fetchRequest.match), withLatestFrom(state$), switchMap(_ref22 => {
...
const tagsUpdateEpic = (action$, state$, _ref23) => {
  ...
  return action$.pipe(filter(tagsSlice.actions.updateRequest.match), withLatestFrom(state$), mergeMap(_ref24 => {
...
const searchFacetTagUpdateEpic = (action$, state$) => action$.pipe(filter(tagsActions.updateComplete.match), withLatestFrom(state$), mergeMap(_ref25 => {
...
createSelector([state => state.search.facets, (_state, directoryId) => directoryId], (searchFacets, directoryId) => searchFacets.some(facet => {
  var _a;
...
const UPLOADS_ACTIONS = {
  uploadComplete: createAction("uploads/uploadComplete", function prepare(_ref26) {
    let {
      asset
    } = _ref26;
    return {
    ...
    fetchRequest: {
      ...
      prepare: _ref27 => {
        let {
          ...
          queryFilter,
          selector = "",
          sort = groq(_a$i || (_a$i = __template$i(["order(_updatedAt desc)"])))
        } = _ref27;
        const pipe = sort || selector ? "|" : "";
        const query = groq(_b$9 || (_b$9 = __template$i(['\n          {\n            "items": *[', "] {\n              _id,\n              _type,\n              _createdAt,\n              _updatedAt,\n              altText,\n              creditLine,\n              description,\n              extension,\n              metadata {\n                dimensions,\n                exif,\n                isOpaque,\n              },\n              mimeType,\n              opt {\n                media\n              },\n              originalFilename,\n              size,\n              source {\n                name\n              },\n              title,\n              url\n            } ", " ", " ", ",\n          }\n        "])), queryFilter, pipe, sort, selector);
        return {
          payload: {
            params,
            query
...
const assetsDeleteEpic = (action$, _state$, _ref29) => {
  ...
  return action$.pipe(filter(assetsActions.deleteRequest.match), mergeMap(action => {
    ...
    return of(assets).pipe(mergeMap(() => client.observable.delete({
      query: groq(_c$4 || (_c$4 = __template$i(["*[_id in ", "]"])), JSON.stringify(assetIds))
...
const assetsFetchEpic = (action$, state$, _ref30) => {
  ...
  return action$.pipe(filter(assetsActions.fetchRequest.match), withLatestFrom(state$), switchMap(_ref31 => {
...
const assetsFetchPageIndexEpic = (action$, state$) => action$.pipe(filter(assetsActions.loadPageIndex.match), withLatestFrom(state$), switchMap(_ref32 => {
  ...
  return of(assetsActions.fetchRequest({
    ...
    selector: groq(_d$1 || (_d$1 = __template$i(["[", "...", "]"])), start, end),
    sort: groq(_e || (_e = __template$i(["order(", " ", ")"])), (_d2 = (_c2 = state.assets) == null ? void 0 : _c2.order) == null ? void 0 : _d2.field, (_f = (_e2 = state.assets) == null ? void 0 : _e2.order) == null ? void 0 : _f.direction)
  }));
}));
const assetsFetchNextPageEpic = (action$, state$) => action$.pipe(filter(assetsActions.loadNextPage.match), withLatestFrom(state$), switchMap(_ref33 => {
  let [_action, state] = _ref33;
  return of(assetsActions.loadPageIndex({
    pageIndex: state.assets.pageIndex + 1
  }));
}));
const assetsFetchAfterDeleteAllEpic = (action$, state$) => action$.pipe(filter(assetsActions.deleteComplete.match), withLatestFrom(state$), switchMap(_ref34 => {
...
const assetsSearchEpic = action$ => action$.pipe(ofType(searchActions.facetsAdd.type, searchActions.facetsClear.type, searchActions.facetsRemoveById.type, searchActions.facetsRemoveByName.type, searchActions.facetsSetDirectory.type, searchActions.facetsRemoveByTag.type, searchActions.facetsUpdate.type, searchActions.facetsUpdateById.type, searchActions.querySet.type), debounceTime(400), mergeMap(() => {
  return of(assetsActions.clear(),
  //
  assetsActions.loadPageIndex({
    pageIndex: 0
...
const assetsTagsAddEpic = (action$, state$, _ref39) => {
  ...
  return action$.pipe(filter(ASSETS_ACTIONS.tagsAddRequest.match), withLatestFrom(state$), mergeMap(_ref40 => {
...
const assetsDirectoriesAddEpic = (action$, state$, _ref41) => {
  ...
  return action$.pipe(filter(ASSETS_ACTIONS.directoriesAddRequest.match), withLatestFrom(state$), mergeMap(_ref42 => {
    ...
    // Dispatch complete action
    mergeMap(() => of(ASSETS_ACTIONS.directoriesAddComplete({
      assets,
      directory
    }))), catchError(error => of(ASSETS_ACTIONS.directoriesAddError({
      assets,
      error: {
        message: (error == null ? void 0 : error.message) || "Internal error",
        statusCode: (error == null ? void 0 : error.statusCode) || 500
...
const assetsTagsRemoveEpic = (action$, state$, _ref43) => {
  ...
  return action$.pipe(filter(ASSETS_ACTIONS.tagsRemoveRequest.match), withLatestFrom(state$), mergeMap(_ref44 => {
...
const assetsDirectoriesRemoveEpic = (action$, state$, _ref45) => {
  ...
  return action$.pipe(filter(ASSETS_ACTIONS.directoriesRemoveRequest.match), withLatestFrom(state$), mergeMap(_ref46 => {
    ...
    // Dispatch complete action
    mergeMap(() => of(ASSETS_ACTIONS.directoriesRemoveComplete({
      assets,
      directory
    }))), catchError(error => of(ASSETS_ACTIONS.directoriesRemoveError({
      assets,
      error: {
        message: (error == null ? void 0 : error.message) || "Internal error",
        statusCode: (error == null ? void 0 : error.statusCode) || 500
...
const assetsUnpickEpic = action$ => action$.pipe(ofType(assetsActions.orderSet.type, assetsActions.viewSet.type, searchActions.facetsAdd.type, searchActions.facetsClear.type, searchActions.facetsRemoveById.type, searchActions.facetsRemoveByName.type, searchActions.facetsSetDirectory.type, searchActions.facetsRemoveByTag.type, searchActions.facetsUpdate.type, searchActions.facetsUpdateById.type, searchActions.querySet.type), mergeMap(() => {
...
const assetsUpdateEpic = (action$, state$, _ref47) => {
  ...
  return action$.pipe(filter(assetsActions.updateRequest.match), withLatestFrom(state$), mergeMap(_ref48 => {
...
const checkDirectoryName = (client, name) => {
  return function (source) {
    return source.pipe(mergeMap(() => {
      return from(client.fetch(groq(_a$g || (_a$g = __template$g(['count(*[_type == "', '" && name.current == $name])'])), DIRECTORY_DOCUMENT_NAME), {
        name
      }));
    }), mergeMap(existingDirectoryCount => {
...
const directoriesSlice = createSlice({
  ...
  reducers: {
    ...
    fetchRequest: {
      ...
      prepare: () => {
        const query = groq(_a$f || (_a$f = __template$f(['\n          {\n            "items": *[\n              _type == "', '"\n              && !(_id in path("drafts.**"))\n            ] {\n              _createdAt,\n              _updatedAt,\n              _id,\n              _rev,\n              _type,\n              name,\n              parent->{\n                ...,\n              }\n            } | order(name asc),\n          }\n        '])), DIRECTORY_DOCUMENT_NAME);
        return {
          payload: {
            query
          }
...
const directoriesCreateEpic = (action$, state$, _ref49) => {
  ...
  return action$.pipe(filter(directoriesSlice.actions.createRequest.match), withLatestFrom(state$), mergeMap(_ref50 => {
    ...
    return of(action).pipe(debugThrottle(state.debug.badConnection), checkDirectoryName(client, name), mergeMap(() => client.observable.create({
    ...
    })), mergeMap(result => of(directoriesSlice.actions.createComplete({
      assetId,
      directory: result
    }), directoriesSlice.actions.fetchRequest())), catchError(error => of(directoriesSlice.actions.createError({
      error: {
        message: (error == null ? void 0 : error.message) || "Internal error",
        statusCode: (error == null ? void 0 : error.statusCode) || 500
      },
...
const directoriesDeleteEpic = (action$, state$, _ref51) => {
  ...
  return action$.pipe(filter(directoriesSlice.actions.deleteRequest.match), withLatestFrom(state$), mergeMap(_ref52 => {
    ...
    mergeMap(() => client.observable.fetch(groq(_c$3 || (_c$3 = __template$f(['*[\n              _type in ["sanity.fileAsset", "sanity.imageAsset"]\n              && references(*[_type == "media.directory" && _id == $directoryId]._id)\n            ] {\n              _id,\n              _rev,\n              opt\n            }']))), {
      directoryId: directory._id
    })),
    ...
    // Dispatch complete action
    mergeMap(() => of(directoriesSlice.actions.fetchRequest())), catchError(error => of(directoriesSlice.actions.deleteError({
      error: {
        message: (error == null ? void 0 : error.message) || "Internal error",
        statusCode: (error == null ? void 0 : error.statusCode) || 500
      },
...
const directoriesFetchEpic = (action$, state$, _ref53) => {
  ...
  return action$.pipe(filter(directoriesSlice.actions.fetchRequest.match), withLatestFrom(state$), switchMap(_ref54 => {
    ...
    mergeMap(result => {
      ...
      return of(directoriesSlice.actions.fetchComplete({
        directories: items
      }));
    }), catchError(error => of(directoriesSlice.actions.fetchError({
      error: {
        message: (error == null ? void 0 : error.message) || "Internal error",
        statusCode: (error == null ? void 0 : error.statusCode) || 500
      }
...
const directoriesListenerCreateQueueEpic = action$ => action$.pipe(filter(directoriesSlice.actions.listenerCreateQueue.match), bufferTime(2e3), filter(actions => actions.length > 0), mergeMap(actions => {
  const directories = actions == null ? void 0 : actions.map(action => action.payload.directory);
  return of(directoriesSlice.actions.listenerCreateQueueComplete({
    directories
  }));
}));
const directoriesListenerDeleteQueueEpic = action$ => action$.pipe(filter(directoriesSlice.actions.listenerDeleteQueue.match), bufferTime(2e3), filter(actions => actions.length > 0), mergeMap(actions => {
  const directoryIds = actions == null ? void 0 : actions.map(action => action.payload.directoryId);
  return of(directoriesSlice.actions.listenerDeleteQueueComplete({
    directoryIds
  }));
}));
const directoriesListenerUpdateQueueEpic = action$ => action$.pipe(filter(directoriesSlice.actions.listenerUpdateQueue.match), bufferTime(2e3), filter(actions => actions.length > 0), mergeMap(actions => {
  const directories = actions == null ? void 0 : actions.map(action => action.payload.directory);
  return of(directoriesSlice.actions.listenerUpdateQueueComplete({
    directories
  }));
}));
const directoriesSortEpic = action$ => action$.pipe(ofType(directoriesSlice.actions.listenerCreateQueueComplete.type, directoriesSlice.actions.listenerUpdateQueueComplete.type), bufferTime(1e3), filter(actions => actions.length > 0), mergeMap(() => of(directoriesSlice.actions.sort())));
const directoriesUpdateEpic = (action$, state$, _ref55) => {
  let {
    client
  } = _ref55;
  return action$.pipe(filter(directoriesSlice.actions.updateRequest.match), withLatestFrom(state$), mergeMap(_ref56 => {
    ...
    mergeMap(() => from(client.patch(directory._id).set({
      name: formData == null ? void 0 : formData.name
    }).commit())),
    // Dispatch complete action
    mergeMap(updatedDirectory => {
      return of(directoriesSlice.actions.updateComplete({
        closeDialogId,
        directory: updatedDirectory
      }));
    }), catchError(error => of(directoriesSlice.actions.updateError({
      error: {
        message: (error == null ? void 0 : error.message) || "Internal error",
        statusCode: (error == null ? void 0 : error.statusCode) || 500
      },
...
const selectDirectories = createSelector([selectDirectoriesByIds, selectDirectoriesAllIds], (byIds, allIds) => allIds.map(id => byIds[id]));
createSelector([selectDirectoriesByIds, (_state, directoryId) => directoryId], (byIds, directoryId) => byIds[directoryId]);
const selectActiveDirectoryState = state => state.directories.activeDirectory;
const selectActiveDirectory = createSelector([selectActiveDirectoryState], activeDirectory => activeDirectory);
...
const dialogDirectoryCreateEpic = action$ => action$.pipe(filter(directoriesActions.createComplete.match), mergeMap(action => {
  const {
    assetId,
    directory
  } = action == null ? void 0 : action.payload;
  if (assetId) {
    return of(dialogSlice.actions.inlineDirectoryCreate({
      directory,
      assetId
    }));
  }
...
const dialogDirectoryDeleteEpic = action$ => action$.pipe(filter(directoriesActions.listenerDeleteQueueComplete.match), mergeMap(action => {
  const {
    directoryIds
  } = action == null ? void 0 : action.payload;
  return of(dialogSlice.actions.inlineDirectoryRemove({
    directoryIds
  }));
}));
...
var _a$e;
const Container$1 = styled(Box)(_ref57 => {
  let {
    scheme,
    theme
  } = _ref57;
  return css(_a$e || (_a$e = __template$e(["\n    background: ", ";\n    border-radius: ", ";\n  "])), getSchemeColor(scheme, "bg"), rem(theme.sanity.radius[2]));
});
...
var _a$d;
const StackContainer = styled(Flex)(_ref64 => {
  let {
    theme
  } = _ref64;
  return css(_a$d || (_a$d = __template$d(["\n    > * {\n      margin-bottom: ", ";\n    }\n  "])), rem(theme.sanity.space[2]));
});
...
var _a$c;
const Container = styled(Box)(_ref69 => {
  let {
    theme
  } = _ref69;
...
const StyledErrorOutlineIcon = styled(ErrorOutlineIcon)(_ref74 => {
  let {
    theme
  } = _ref74;
  return {
...
var _a$b, _b$6;
const Image$1 = styled.img(_b$6 || (_b$6 = __template$b(["\n  --checkerboard-color: ", ";\n\n  display: block;\n  width: 100%;\n  height: 100%;\n  object-fit: contain;\n\n  ", "\n"])), props => props.scheme ? getSchemeColor(props.scheme, "bg2") : "inherit", props => props.showCheckerboard && css(_a$b || (_a$b = __template$b(["\n      background-image: linear-gradient(45deg, var(--checkerboard-color) 25%, transparent 25%),\n        linear-gradient(-45deg, var(--checkerboard-color) 25%, transparent 25%),\n        linear-gradient(45deg, transparent 75%, var(--checkerboard-color) 75%),\n        linear-gradient(-45deg, transparent 75%, var(--checkerboard-color) 75%);\n      background-size: 20px 20px;\n      background-position: 0 0, 0 10px, 10px -10px, -10px 0;\n    "]))));
            ...
            return /* @__PURE__ */jsxs(Fragment, {
              children: [/* @__PURE__ */jsxs(TabList, {
                ...
                children: [!assetItem && /* @__PURE__ */jsx(Card, {
                  ...
                  children: /* @__PURE__ */jsxs(Stack, {
                    space: 3,
                    children: [/* @__PURE__ */jsx(FormFieldInputTags, {
                      control,
                      disabled: formUpdating,
...
var _a$8, _b$5;
const TagContainer = styled(Flex)(_a$8 || (_a$8 = __template$8(["\n  height: ", "px;\n"])), PANEL_HEIGHT);
const ButtonContainer = styled(Flex)(_b$5 || (_b$5 = __template$8(["\n  @media (pointer: fine) {\n    visibility: hidden;\n  }\n\n  @media (hover: hover) and (pointer: fine) {\n    ", ":hover & {\n      visibility: visible;\n    }\n  }\n"])), TagContainer);
...
const VirtualRow$1 = memo(_ref77 => {
  let {
    isScrolling,
    item
  } = _ref77;
...
const Dialogs = () => {
  ...
  const renderDialogs = (dialogs, index) => {
    ...
    if (dialog.type === "directoryCreate") {
      return /* @__PURE__ */jsx(DialogDirectoryCreate, {
        dialog,
        children: childDialogs
      }, index);
    }
...
const uploadsAssetUploadEpic = (action$, state$) => action$.pipe(filter(uploadsActions.uploadRequest.match), withLatestFrom(state$), mergeMap(_ref83 => {
...
const uploadsCheckRequestEpic = (action$, state$, _ref84) => {
  ...
  return action$.pipe(filter(uploadsActions.checkRequest.match), withLatestFrom(state$), mergeMap(_ref85 => {
    let [action, state] = _ref85;
    const {
      assets
    } = action.payload;
    const documentIds = assets.map(asset => asset._id);
    const query = groq(_a$6 || (_a$6 = __template$6(["\n        *[_id in $documentIds].sha1hash\n      "])));
...
var _a$5;
const CardWrapper = styled(Flex)(_a$5 || (_a$5 = __template$5(["\n  box-sizing: border-box;\n  height: 100%;\n  overflow: hidden;\n  position: relative;\n  width: 100%;\n"])));
...
const ItemContainer = styled.div(_a$4 || (_a$4 = __template$4(["\n  height: ", "px;\n  width: ", "px;\n"])), CARD_HEIGHT, CARD_WIDTH);
const ListContainer = styled.div(_b$3 || (_b$3 = __template$4(["\n  display: grid;\n  grid-template-columns: repeat(auto-fill, ", "px);\n  grid-template-rows: repeat(auto-fill, ", "px);\n  justify-content: center;\n  margin: 0 auto;\n"])), CARD_WIDTH, CARD_HEIGHT);
...
var _a$3;
const ContextActionContainer$1 = styled(Flex)(_ref87 => {
  let {
    scheme
  } = _ref87;
...
const ContainerGrid = styled(Grid)(_ref88 => {
  let {
    scheme,
    selected,
    updating
...
const ContextActionContainer = styled(Flex)(_ref89 => {
  let {
    scheme
  } = _ref89;
  return css(_c$1 || (_c$1 = __template$2(["\n    cursor: pointer;\n    @media (hover: hover) and (pointer: fine) {\n      &:hover {\n        background: ", ";\n      }\n    }\n  "])), getSchemeColor(scheme, "bg2"));
});
const StyledWarningIcon = styled(WarningFilledIcon)(_ref90 => {
  let {
    theme
  } = _ref90;
  return {
...
const notificationsDirectoryCreateCompleteEpic = action$ => action$.pipe(filter(directoriesActions.createComplete.match), mergeMap(() => of(notificationsSlice.actions.add({
  status: "info",
...
const notificationsDirectoryDeleteCompleteEpic = action$ => action$.pipe(filter(directoriesActions.deleteComplete.match), mergeMap(() => of(notificationsSlice.actions.add({
  status: "info",
...
const notificationsDirectoryUpdateCompleteEpic = action$ => action$.pipe(filter(directoriesActions.updateComplete.match), mergeMap(() => of(notificationsSlice.actions.add({
  status: "info",
...
var _a$1, _b$1;
const UploadContainer = styled.div(_a$1 || (_a$1 = __template$1(["\n  color: white;\n  height: 100%;\n  min-height: 100%;\n  right: 0;\n  top: 0;\n  width: 100%;\n\n  &:focus {\n    outline: none;\n  }\n"])));
const DragActiveContainer = styled.div(_b$1 || (_b$1 = __template$1(["\n  align-items: center;\n  background: rgba(0, 0, 0, 0.75);\n  display: flex;\n  height: 100%;\n  justify-content: center;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 100%;\n  z-index: 3;\n"])));
    ...
    children: /* @__PURE__ */jsxs(Flex, {
      ...
      children: [/* @__PURE__ */jsxs(Inline, {
        ...
        children: [/* @__PURE__ */jsx(Label, {
          size: 0,
          children: title
        }), directoriesFetching && /* @__PURE__ */jsx(Label, {
          size: 0,
          style: {
            opacity: 0.3
          },
...
const DirectoryIcon = () => /* @__PURE__ */jsx("svg", {
...
const Children = _ref96 => {
  ...
  return /* @__PURE__ */jsx("div", {
    ...
    children: childDirectories.map(directory => /* @__PURE__ */jsx(Directory, {
      directory
...
const Directory = _ref97 => {
  ...
  const assetsPicked = useTypedSelector(selectAssetsPicked);
  const [droppedAsset, setDroppedAsset] = useState(null);
  const handleDrop = e => {
  ...
  return /* @__PURE__ */jsxs("div", {
    ...
    children: [/* @__PURE__ */jsxs("div", {
      ...
      children: [/* @__PURE__ */jsxs("div", {
        ...
        children: [/* @__PURE__ */jsx(DirectoryIcon, {}), "\xA0", directory.directory.name]
      }), /* @__PURE__ */jsx("div", {
        style: {
          marginLeft: "auto",
          marginRight: "5px",
        ...
        children: /* @__PURE__ */jsxs(Fragment, {
          ...
          }), !!directory.open && directory.childDirectories && /* @__PURE__ */jsx(ChevronDownIcon, {
            onClick: toggleOpen
          }), !directory.open && directory.childDirectories && /* @__PURE__ */jsx(ChevronRightIcon, {
            onClick: toggleOpen
          })]
        })
      })]
    }), (root || directory.open) && directory.childDirectories && /* @__PURE__ */jsx(Children, {
      childDirectories: directories.filter(d => {
        var _a;
...
const DirectoryView = () => {
  ...
  return /* @__PURE__ */jsxs(Flex, {
    ...
    flex: 1,
    height: "fill",
    children: [/* @__PURE__ */jsx(DirectoryViewHeader, {
      allowCreate: true,
      light: hasPicked,
      title: hasPicked ? "Directories (in selection)" : "Directories"
    }), fetchComplete && !hasDirectories && /* @__PURE__ */jsx(Box, {
      padding: 3,
      children: /* @__PURE__ */jsx(Text, {
        muted: true,
        size: 1,
    ...
    }), hasDirectories && /* @__PURE__ */jsx(Fragment, {
      children: rootDirectories.map(directory => {
        return /* @__PURE__ */jsx(Directory, {
          directory
        }, directory.directory._id);
      })
    })]
...
const DirectoriesPanel = () => {
  ...
  return /* @__PURE__ */jsx(Box, {
    ...
    children: /* @__PURE__ */jsx(Box, {
      ...
      children: /* @__PURE__ */jsx(DirectoryView, {})
    })
  });
};
...
const BrowserContent = _ref98 => {
  ...
  useEffect(() => {
    ...
    const subscriptionDirectory = client.listen(groq(_c || (_c = __template(['*[_type == "', '" && !(_id in path("drafts.**"))]'])), DIRECTORY_DOCUMENT_NAME)).subscribe(handleDirectoryUpdate);
    return () => {
      subscriptionAsset == null ? void 0 : subscriptionAsset.unsubscribe();
      ...
      children: [/* @__PURE__ */jsx(Dialogs, {}), /* @__PURE__ */jsx(Notifications, {}), /* @__PURE__ */jsx(Card, {
        ...
        children: /* @__PURE__ */jsxs(Flex, {
          ...
          children: [/* @__PURE__ */jsx(Header, {
            ...
            flex: 1,
            children: [/* @__PURE__ */jsx(DirectoriesPanel, {}), /* @__PURE__ */jsxs(Flex, {
              align: "flex-end",
              direction: "column",
              flex: 1,
              style: {
